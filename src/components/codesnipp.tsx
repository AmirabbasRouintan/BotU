...
const CodeSnippet: React.FC = () => {
  return (
    <div className="w-full max-w-2xl mx-auto mb-20 p-4 font-sans">
      ...
      <div className="bg-[#3131315b] backdrop-blur p-4 rounded-b-lg border border-white/10">
        <pre className="text-gray-200 overflow-x-auto font-mono text-sm sm:text-base">
          <code>
        ...
        <div className="mt-4 flex flex-wrap items-center text-sm text-gray-300 backdrop-blur-sm py-2 px-3 rounded gap-1">
